  ...
  return (
    <div className="flex flex-col min-h-full bg-bass-black">
      ...
      <section className="relative h-[600px] md:h-[900px] w-full flex items-center px-6 md:px-20 overflow-hidden">
        <Image src={soundHeroData.image} alt="" fill className="object-cover img-greyscale" />
      ...
      <section className="relative h-[400px] md:h-[700px] w-full max-w-[1440px] mx-auto flex items-center justify-center px-6 md:px-20 rounded-lg overflow-hidden">
        <Image src={soundSubwayData.image} alt="" fill className="object-cover img-greyscale" />
        <div className="absolute inset-0 bg-(--color-primary)/10 z-[1]" />
      ...
      <section className="py-20 md:py-[160px] flex justify-center">
        <Link href="/events" className="inline-flex h-14 px-8 items-center justify-center rounded-lg bg-(--color-primary) text-btn text-bass-white hover:bg-(--color-primary)/80 transition-colors">{soundCtaData.label}</Link>
      </section>
